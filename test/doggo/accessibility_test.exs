defmodule Doggo.AccessibilityTest do
  ...
  describe "names_on_nameless_elements/1" do
    test "rejects name on div or span without role" do
  ...
  describe "nameless_interactive_elements/1" do
    test "rejects button named only by title" do
  ...
  describe "expanded_state/1" do
    test "rejects collapsed control with visible content" do
    ...
    test "rejects expanded control with hidden content" do
      assert_raise ExUnit.AssertionError, ~r/disagrees with/, fn ->
        Accessibility.expanded_state(
    ...
    test "accepts states that agree" do
    ...
    test "ignores control without target in document" do
      Accessibility.expanded_state(
        parse(
