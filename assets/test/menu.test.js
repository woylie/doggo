...
describe("initMenu", () => {
  describe("with a menu", () => {
    ...
    it("keeps one tab stop over every item, including nested groups", () => {
    ...
    it("stays on a match when the search grows", () => {
      item("Copy").focus();
  ...
  describe("with a menu button", () => {
    ...
    it("closes on a click outside without moving the focus", () => {
  ...
  describe("with a menu bar", () => {
    ...
    it("moves with the horizontal keys", () => {
      el.querySelector('[role="menuitem"]').focus();
  ...
  describe("with an id that is not a valid selector", () => {
    it("finds the button", () => {
      document.body.innerHTML =
